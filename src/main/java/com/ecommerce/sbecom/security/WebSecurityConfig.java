...
@Configuration
//@Configuration: Marks a class as a source of bean definitions and Spring configuration. It allows you to define beans using the @Bean annotation.
@EnableWebSecurity
...
//Defines URL patterns that are publicly accessible.
//Requires authentication for all other requests.
//Configures a custom authentication provider.
//Adds a custom JWT token filter to the security filter chain.
    }
